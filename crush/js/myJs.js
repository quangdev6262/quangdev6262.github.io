...
function textGenerate() {
    var n = "";
    var text = " Tại vì cậu đẹp trai chứ sao nữa :D:D:D ";
...
$('#yes').click(function() {
    ...
    Swal.fire({
        ...
        cancelButtonText: "Thôi.Tớ ngại lém :<<",
